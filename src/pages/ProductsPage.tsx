  ...
  const categories = [
    {
      ...
      products: [
        ...
        },
        {
          ...
          image: "https://ysamarket.com/wp-content/uploads/2021/06/seeraga-samba-600x400.jpg",
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          image: "https://cdn.shopaccino.com/edible-smart/products/black-chana-317452_l.jpg?v=530",
      ...
      products: [
        {
          ...
          image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/A_closeup_fo_Samai_millet_with_husk.JPG/1200px-A_closeup_fo_Samai_millet_with_husk.JPG",
          features: ["Organic", "High Protein", "Quick Cooking"],
          packaging: ["500g", "1kg", "5kg"]
        },
        {
          name: "Kodo Millet [Varagu]",
          description: "High Antioxidant potential and ideal for vegetarian diet",
          image: "https://cdn.shopaccino.com/edible-smart/products/black-chana-317452_l.jpg?v=530",
          features: ["Premium Quality", "Rich in Fiber", "Versatile"],
          packaging: ["500g", "1kg", "5kg"]
        },
        {
          ...
          description: "The high level of fibers significantly slows down the pace of digestion thereby helping in lowering blood sugar levels.",
          image: "https://www.payirfoods.com/wp-content/uploads/2022/02/4.-FOXTAIL-MILETS.jpg",
          features: ["Premium Quality", "Rich in Fiber", "Versatile"],
          packaging: ["500g", "1kg", "5kg"]
        },
        {
          name: "Barnyard Millet [Kuthirai Vali]",
          description: "The rice for fasting. As a dietary fibers can hold up to eight times water than their mass thereby helps bowel cleansing easier.",
          image: "https://www.kannukutty.in/static/images/1/3027871b-75af-4889-9f20-d7db326bce07.jpg",
          features: ["Premium Quality", "Rich in Fiber", "Versatile"],
          packaging: ["500g", "1kg", "5kg"]
        },
      ]
