...
const products = [
  ...
  },
  {
    ...
    description: 'Nutritious and delicious snacks for health-conscious consumers.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our range of premium agricultural products, carefully selected and processed
