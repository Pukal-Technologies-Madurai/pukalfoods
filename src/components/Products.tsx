    ...
    items: [
      {
        ...
        image: "https://images.unsplash.com/photo-1515942400420-2b98fed1f515?auto=format&fit=crop&q=80"
      },
      {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            Discover our extensive range of premium quality agricultural products, 
            carefully sourced and processed to meet the highest standards.
          </p>
        </motion.div>
